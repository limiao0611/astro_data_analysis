...
#  p=yt.SlicePlot(ds,'x',fields,center=c1,axes_unit='kpc',fontsize=11,width=(150,'kpc'))
  p=yt.SlicePlot(ds,'x',fields,center=c1,axes_unit='kpc',fontsize=11 ) #,width=(30,'kpc') )#, width=(300,'kpc'))
...
#num=[1,10,30,50,100,150,200,250,300,400]
num=[3,5,7,9,200,300,400,500]
#num=[60,70]
num=range(250,800,30)
#num=range(0,10)
