...
#   hot = sp.cut_region("obj['temperature'] > 1. ") 
   hot = sp['temperature'].in_units('K') > 6e5
   wh = (sp['temperature'].in_units('K') < 6e5) & (sp['temperature'].in_units('K') > 3e4)
   cool = sp['temperature'].in_units('K') < 3e4
