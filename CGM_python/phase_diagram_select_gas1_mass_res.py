...
#   plot.set_unit('dx','kpc')
   plot.set_unit('cell_mass','msun')
#   plot.set_unit('radial_velocity','km/s')
#   plot.set_unit('x-velocity','km/s')
#   plot.set_log('radial_velocity',0)
#   plot.set_log('x-velocity',0)
   plot.set_ylim(30,3e5)
   plot.set_xlim(10,400)
   plot.set_zlim(c, 1e3, 5e6)
#   plot.save(a+'_'+b+'_'+c  +str(i)+'_hot_enriched.png')
   plot.save(a+'_'+b+'_'+c+'_all'+str(i)+'.png')
