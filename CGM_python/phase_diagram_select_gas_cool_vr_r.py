...
#   b='metallicity'
 ...
 #   d='cell_volume'
   ...
   plot = PhasePlot(cool,a,b,c,weight_field=d, fontsize=25)
...
#   plot.set_log('x-velocity',0)
   ...
   plot.set_zlim(c, 0.3e37, 3e38)
   plot.set_cmap("cell_mass", "GnBu")
   plot.save(a+'_'+b+'_'+c  +str(i)+'_cool.png')
